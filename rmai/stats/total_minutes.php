...
$map = array('7d' => array(_('Last 7 Days').' - '._('Daily Total Minutes'),_('Day')),
             '4w' => array(_('Last 4 Weeks').' - '._('Total Minutes per Week'),_('Week year')),
             'm' =>  array(_('Total Monthly Minutes'),_('Month')));
